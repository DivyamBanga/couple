...
export const GAMES = [
  ...
  // ── silly 🤪 ────────────────────────────────────────────────
  { id: 'drawguess',  name: 'draw & guess',      emoji: '🎨', tagline: 'art school dropout',      mood: 'silly',  engine: 'canvas',    status: 'soon', load: () => import('./drawguess/game.js') },
  { id: 'telephone',  name: 'doodle telephone',  emoji: '📞', tagline: 'it gets worse every turn', mood: 'silly', engine: 'canvas',    status: 'soon', load: () => import('./telephone/game.js') },
  { id: 'twentyq',    name: '20 questions',      emoji: '❓', tagline: 'yes, no, maybe so',       mood: 'silly',  engine: 'prompt',    status: 'soon', load: () => import('./twentyq/game.js') },
  { id: 'twotruths',  name: 'two truths & a lie', emoji: '🤥', tagline: 'spot my nonsense',       mood: 'silly',  engine: 'prompt',    status: 'soon', load: () => import('./twotruths/game.js') },
  { id: 'emojidecode', name: 'emoji decode',     emoji: '🧩', tagline: 'translate my brain',      mood: 'silly',  engine: 'prompt',    status: 'soon', load: () => import('./emojidecode/game.js') },
  { id: 'describeit', name: 'describe it badly', emoji: '🗯️', tagline: 'worst explanation wins',  mood: 'silly',  engine: 'prompt',    status: 'soon', load: () => import('./describeit/game.js') },
  { id: 'storybuilder', name: 'story builder',   emoji: '📖', tagline: 'co-write a disaster',     mood: 'silly',  engine: 'prompt',    status: 'soon', load: () => import('./storybuilder/game.js') },

  // ── daily ☀️ ────────────────────────────────────────────────
  { id: 'dailyq',     name: 'question of the day', emoji: '☀️', tagline: 'answer blind, reveal together', mood: 'daily', engine: 'viewer', status: 'soon', load: () => import('./daily/question.js') },
  { id: 'dailyword',  name: 'daily word',          emoji: '🟨', tagline: 'same word, who solves it faster', mood: 'daily', engine: 'viewer', status: 'soon', load: () => import('./daily/wordle.js') },
  { id: 'dailytot',   name: 'daily this-or-that',  emoji: '☕', tagline: '60-second ritual',       mood: 'daily',  engine: 'viewer',    status: 'soon', load: () => import('./daily/thisorthat.js') },
];
